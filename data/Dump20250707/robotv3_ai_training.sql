...
CREATE TABLE `ai_training` (
  ...
  `active` int NOT NULL,
  `createdby` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `ai_training` VALUES (359,24,77,'Login','2',1,'goffipl','02/06/2025 09:13');
