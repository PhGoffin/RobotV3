  ...
  */
  ...
  testScenario: async (data) => {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      // write the scenario name in the reference for the title in the logfile
      ret = await robot.evaluateFunction(driver, variables, 'setReference', data, 'Scenario Name', data.scenarioName, 'Name of the current scenario')
      ...
      try {
        ...
        if (ret.stop != 99) {
          ...
          return resolve({ success: 0, message: "Browser not responding!", stop: 99 })
        }
  ...
  testSuite: (data) => {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      const { deleteLogfile } = require("../../logfile/logfile.service");
      const { getReferenceByCode } = require("../../reference/reference.service");
      const { startBrowser, stopBrowser } = require("../browser/browser.service.js")
  ...
  testStory: (data) => {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      const { getTestByScenario } = require("../../test/test.service");
      const { getSuiteByHeader } = require("../../suite/suite.service");
      const { getStory } = require("../../story/story.service");
      const { deleteLogfile } = require("../../logfile/logfile.service");
      const { getReferenceByCode } = require("../../reference/reference.service");
      const { startBrowser, stopBrowser } = require("../browser/browser.service.js")
  ...
  testAllStory: (data) => {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      const { getTestByScenario } = require("../../test/test.service");
      const { getSuiteByHeader } = require("../../suite/suite.service");
      const { getStoryByHeader } = require("../../story/story.service");
      const { getReferenceByCode } = require("../../reference/reference.service");
      const { deleteLogfile } = require("../../logfile/logfile.service");
      const { startBrowser, stopBrowser } = require("../browser/browser.service.js")
  ...
  cryptpassword: (data) => {
    return new Promise(async (resolve, reject) => {
      ...
      const robot = require("../library/robot.library")
      const { cryptPassword } = require("../library/password.library")
  ...
  decryptpassword: (data) => {
    return new Promise(async (resolve, reject) => {
      ...
      const robot = require("../library/robot.library")
      const { decryptPassword } = require("../library/password.library")
  ...
  checkFilename: (body) => {
    return new Promise(async (resolve, reject) => {
      ...
      const { fileExist } = require("../library/file.library")
