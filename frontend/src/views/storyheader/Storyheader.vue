            ...
            <div class="entity">
                ...
                <div class="entities"  height="150px">
                    ...
                    <div v-if="filteredData.length" class="layout">
                        <StoryheaderList class="storyheadersList" :storyheaders="filteredData" :workspaceID="workspaceID"
                            ...
                            @refreshstoryheaders="refreshStoryheaders" @selectrecord="selectRecord" @handleinsert="handleInsert"
