<template>
    <div class="my-container">
        ...
        <div class="form">
            <div class="banner">
                <h3 class="title">Batch</h3>
                <img src="../../assets/WorkInProgress.png" alt="robot">
                <Transition>
...
export default {
    ...
    setup(props, context) {
        ...
        displayMsg('Workspace.vue', trace.value)
        consoleLog('Workspace.vue - props', 1, props, trace.value)
        ...
        return { errorMessage, styleMessage, trace,
            handleCancel
        }
