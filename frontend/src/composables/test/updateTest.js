 ...
 * @Last Modified time: 2026-03-11 16:19:29
...
const updateTest = ( action, comment, commentType, transpose, testCondition, functionID, parameter1, parameter2, parameter3, parameter4, parameter5, parameter6, parameter7, parameter8, active, testID) => {
            ...
            if (process.env.VUE_APP_DATABASE == 'LOCAL') {
                ...
                let data = await fetch(url + 'test/update', {
                    ...
                    body: JSON.stringify({ 'action': action, 'comment': comment, 'commentType': commentType, 'transpose': transpose, 'testCondition': testCondition, 'functionID': functionID,
                     ...
                     'parameter5': parameter5, 'parameter6': parameter6, 'parameter7': parameter7 , 'parameter8': parameter8, 'active': active, 'testID': testID  })
                })
                if (!data.ok) {
