 ...
 * @Last Modified time: 2026-04-29 16:25:24
    ...
    const execStory = async (selenium, trace) => {
        try {
            ...
            if (process.env.VUE_APP_DATABASE == 'LOCAL') {
                ...
                //console.log('url', url + 'playwright/robot/story')
                //console.log('storyName:' + storyName + ', storyheaderID:' + storyheaderID + ', storyID:' + storyID + ', projectID:' + projectID + ', subprojectID:' + subprojectID + ', userID:' + userID + ', userName:' + userName + ', resetLog: ' + resetLog)
